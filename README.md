...
| -------- | ---------- | ----------------------------------------------------------- | ----------------------------- |
| Sprint 0 | Preparação | Ambiente, Git, PyTorch, estrutura do repositório            | Em andamento                  |
| Sprint 1 | Cap. 1     | Introdução a LLMs, glossário, Quiz 1, mapa conceitual GPT   | Glossário do Carlos concluído |
